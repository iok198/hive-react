...
class MasteryStuTR extends React.Component {
    ...
    render(){
        return (
            <tr
                id={"mastery-row-" + this.props.stuUDID }
                className="mastery-row"
            >
                <MasteryStuKeyTD
                    key={"mKeyTD" + this.props.stuUDID}
                    mRating0s={this.props.mRating0s}
                    mRatingStr={this.props.mRatingStr}
                    stuUDID={this.props.stuUDID}
                    stuBio={this.props.stuBio}
                />
