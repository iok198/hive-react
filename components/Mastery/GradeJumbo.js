  ...
  render(){
    ...
    return( <div className="jumbotron">
      ...
      <table id="" className="table table-bordered">
              ...
              {Object.keys(this.state.parsedMastery.rowsByStu).slice(0,5).map((stuUDID,id1) => (<MasteryStuTR key={stuUDID} stuData={this.state.parsedMastery.rowsByStu[stuUDID]} mRating0s={this.state.parsedMastery.mRating0s[stuUDID]} mStrs={this.state.parsedMastery.mStrs[stuUDID]} stuUDID={stuUDID} colOffset={id1} page={this.state.page} changer={this.changeMastery} />))}
              </tbody>
	    </table>
	    </div> );
  }
