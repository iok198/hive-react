...
class AssessmentStuTR extends React.Component {
    ...
    render(){
        ...
        if(!!this.state.courseLOIDs[id+4*this.props.page] ){
            return <AssessmentStuTD key={this.state.courseLOIDs[id+4*this.props.page] + '-' + this.props.stuUDID} mRatingStr={this.props.mRatingStr} stuUDID={this.props.stuUDID} LOID={this.state.courseLOIDs[id+4*this.props.page]} mArrKey={(this.props.stuData.studentRowsId >= 0) ? this.props.stuData.studentRowsId : -1} ratingData={!!this.props.stuData.ratings[this.state.courseLOIDs[id+4*this.props.page]] ? this.props.stuData.ratings[this.state.courseLOIDs[id+4*this.props.page]] : {mcountA:0,mcountE:0,mcountM:0,mcountN:0,mRating0:1}} colOffset={id} changer={this.props.changer}/>
            } else return null
        })}
        </tr>
    }
