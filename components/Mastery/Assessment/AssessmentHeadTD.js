...
class AssessmentHeadTD extends React.Component {
    render() {
        return (
            <td id={"Assessment-col-head-" + this.props.mRecord.courseStrLOID} className="Assessment-column" style={{ left: (40 + this.props.colOffset * 140) + 'px' }}>
...
export default AssessmentHeadTD