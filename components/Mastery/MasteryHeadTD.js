...
class MasteryHeadTD extends React.Component {
    render() {
        return (
            <td id={`mastery-col-head-${this.props.mRecord.courseStrLOID}`} className="mastery-column" style={{ left: `${40 + this.props.colOffset * 140}px` }}>
