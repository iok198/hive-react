        ...
        return <td id={"mastery-col-" + this.props.ratingData.courseStrLOIDsID } className="mastery-column" >
                        <form>
                          <div className="form-group">
                            <select className="form-control" id="sel1" value={ this.state.mRating0 } onChange={this.props.changer(this.props.ratingData.stUDID,this.props.ratingData.LOID,this.state.mRating0)}>
