...
passport.use(new GoogleStrategy(googPassCred,
  function(accessToken, refreshToken, profile, done) {
       ...
       console.log("SELECT * FROM hive1617.userDirectory WHERE emailID REGEXP " + "'" + profile.emails[0].value + "'")
       connection.query("SELECT * FROM hive1617.userDirectory WHERE emailID REGEXP " + "'" + profile.emails[0].value + "'",
